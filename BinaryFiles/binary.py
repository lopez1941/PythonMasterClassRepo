# strings and ints need converted using bytes
# 'bw' to tell python to make a binary file, otherwise defaults to text file
...
# ints have a built in 'to_bytes' function
...
# to read, ints have a built in 'from_bytes function
